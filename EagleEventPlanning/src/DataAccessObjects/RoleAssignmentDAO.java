...
public class RoleAssignmentDAO {
	...
	public static List<RoleAssignment> listRoleAssignment() {
		TypedQuery<RoleAssignment> query = EM.getEM()
				.createQuery("SELECT roleAssignment FROM roleAssignment roleAssignment", RoleAssignment.class);
	...
	public static RoleAssignment findRoleAssignmentByRoleAssignmentName(String roleAssignmentname) {
		String qString = "SELECT roleAssignment FROM roleAssignment roleAssignment  WHERE roleAssignment.roleAssignmentname ="
				+ roleAssignmentname;
